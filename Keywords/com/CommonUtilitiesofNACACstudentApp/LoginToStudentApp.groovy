...
public class LoginToStudentApp {
	@Keyword
	def loginToStudentApp(String username,String password) {
		...
		WebUI.setText(findTestObject('Object Repository/NacacStudentApp/SignUpPage/EmailTextField'),username)
