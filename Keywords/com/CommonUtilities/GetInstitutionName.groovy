...
public class GetInstitutionName {

	def getInstitutionNameFromAdminApp() {
		...
		GlobalVariable.InstitutionValue=institutionName

		return GlobalVariable.InstitutionValue
	}
}
