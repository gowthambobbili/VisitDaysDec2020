...
class ScheduleMethods {
	...
	@Keyword
	def ScheduleARequest() {

		if(WebUI.verifyElementPresent(findTestObject('ScheduleModalObjects/ScheduleNewVisitButton'), 10, FailureHandling.OPTIONAL)) {
			WebUI.click(findTestObject('ScheduleModalObjects/ScheduleNewVisitButton'))
		}
		WebUI.waitForElementPresent(findTestObject('ScheduleModalObjects/StartTimeFieldInScheduleRequestModal'), 15)
