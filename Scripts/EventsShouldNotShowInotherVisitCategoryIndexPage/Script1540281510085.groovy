...
if (!(WebUI.verifyTextPresent(EventVisitType, false, FailureHandling.OPTIONAL))) {
    KeywordUtil.markFailed('Created Event is not shown in the Index page after applying filters')
...
if (!(WebUI.verifyTextNotPresent(EventVisitType, false, FailureHandling.OPTIONAL))) {
    KeywordUtil.markFailed('Events are shown in the index page of Daily Visits')
...
if (!(WebUI.verifyTextNotPresent(EventVisitType, false, FailureHandling.OPTIONAL))) {
    KeywordUtil.markFailed('Events are shown in the index page of Off-Campus')
