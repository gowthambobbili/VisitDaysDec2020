...
String EventVisitVisitType = CustomKeywords.'com.CommonUtilities.RequestMethods.CreateRequestEventVisitType'()

CustomKeywords.'com.CommonUtilities.CreationOperations.CreateEventWithRequestVisitType'(EventVisitVisitType)
...
CustomKeywords.'com.CommonUtilities.RescheduleMethods.RescheduleIndividualVisit'(StudentName, EventVisitVisitType)
...
CustomKeywords.'com.CommonUtilities.RescheduleMethods.RescheduleGroupVisit'(GroupName, EventVisitVisitType)
