...
def PrefilledDataVerification(String VisitType, String RegistrationMethodOfVisitType) {
	CustomKeywords.'com.CommonUtilities.Verifications.VerifyElementPresentAndStopExecutionIfFailed'(findTestObject('EventsPage/CreateEventHeader'),
			'While creating Event visit type if user clicks \'Create Event\' button then Create Event page is not opened ')
	...
	CustomKeywords.'com.CommonUtilities.Verifications.VerifyElementPresentAndStopExecutionIfFailed'(findTestObject('DailyVisitsPage/VisitTypeFieldInDailyVisit'),
			'While creating Event visit type if user clicks \'Create Event\' button then Visit type drop down is not shown in Create Event page')
	...
	CustomKeywords.'com.CommonUtilities.Verifications.VerifyElementPresentAndStopExecutionIfFailed'(findTestObject('DailyVisitsPage/SelectedVisitTypeInVisitTypeDropdown'),
			'While creating Event visit type if user clicks \'Create Event\' button then Visit type is not pre-filled and it shows empty')
