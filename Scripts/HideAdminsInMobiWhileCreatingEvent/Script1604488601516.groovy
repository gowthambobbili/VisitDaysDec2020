...
String VisitTypes = CustomKeywords.'com.CommonUtilities.RequestMethods.CreateInstantEventVisitTypeWithManualCheckin'()

CustomKeywords.'com.CommonUtilities.CreateVisitWithDifferentStatuses.CreateEventWithInprogressTimesAndHideAdmins'(VisitTypes)
...
if(WebUI.verifyElementPresent(findTestObject('Object Repository/Add Attendee/VerifyAdminShownInDailyVisit',['VisitName':VisitTypes]),5,FailureHandling.OPTIONAL))
{
	KeywordUtil.markFailed('Admin users are not hideen in mobi of student evr link')
}
