...
WebUI.waitForElementVisible(findTestObject('ElementsUnderProfileAvatar/My Profile/EditButtonInAdminProfile'), 0)
...
WebUI.verifyElementNotPresent(findTestObject('ElementsUnderProfileAvatar/My Profile/EmailFieldInAdminUserProfile'), 0)
