...
WebUI.verifyElementPresent(findTestObject('DailyVisitsPage/CreateDailyVisitHeader'), 0)

CustomKeywords.'com.CommonUtilities.RequestMethods.CreateInstantEventVisitTypeWithManualCheckin'()

WebUI.verifyElementPresent(findTestObject('EventsPage/CreateEventHeader'), 0)

CustomKeywords.'com.CommonUtilities.RequestMethods.CreateInstantOffCampusVisitTypeWithManualCheckin'()

WebUI.verifyElementPresent(findTestObject('OffCampusPage/CreateOffCampusHeader'), 0)
