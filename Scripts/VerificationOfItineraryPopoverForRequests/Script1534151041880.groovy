...
WebUI.waitForElementClickable(findTestObject('Add Attendee/HowManyGuestsDropDown'), 0)
...
not_run: CustomKeywords.'com.CommonUtilities.Quit.QuitMobi'()

not_run: WebUI.waitForElementPresent(findTestObject('HomePageElements/VisitTypesLeftNav'), 0)

not_run: String EventVisitType = CustomKeywords.'com.CommonUtilities.RequestMethods.CreateRequestEventVisitType'()

not_run: CustomKeywords.'com.CommonUtilities.CreationOperations.CreateEventWithRequestVisitType'(EventVisitType)

not_run: CustomKeywords.'com.CommonUtilities.PopoverVerification.MyItineraryPopoverVerification'(EventVisitType, findTestObject(
        'Add Attendee/EventsOptionInAddAttendee'))

not_run: CustomKeywords.'com.CommonUtilities.Quit.QuitMobi'()

not_run: WebUI.waitForElementPresent(findTestObject('HomePageElements/VisitTypesLeftNav'), 0)

not_run: String OffCampusVisitType = CustomKeywords.'com.CommonUtilities.RequestMethods.CreateRequestOffCampusVisitType'()

not_run: CustomKeywords.'com.CommonUtilities.CreationOperations.CreateOffCampusWithRequestVisitType'(OffCampusVisitType)

not_run: CustomKeywords.'com.CommonUtilities.PopoverVerification.MyItineraryPopoverVerification'(OffCampusVisitType, findTestObject(
