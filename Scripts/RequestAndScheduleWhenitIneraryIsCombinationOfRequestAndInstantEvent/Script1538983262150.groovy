...
CustomKeywords.'com.CommonUtilities.CreationOperations.CreateEventWithRequestVisitType'(RequestVisitType)

String InstantVisitType = CustomKeywords.'com.CommonUtilities.RequestMethods.CreateInstantEventVisitTypeWithManualCheckin'()

CustomKeywords.'com.CommonUtilities.CreationOperations.CreateEventWithInstantVisitType'(InstantVisitType)
...
String IndividualStudent = CustomKeywords.'com.CommonUtilities.ConfirmationPage.RegistrationOfACombinationOfRequestAndInstant'(
    RequestVisitType, InstantVisitType, findTestObject('Add Attendee/EventsOptionInAddAttendee'), Single)
