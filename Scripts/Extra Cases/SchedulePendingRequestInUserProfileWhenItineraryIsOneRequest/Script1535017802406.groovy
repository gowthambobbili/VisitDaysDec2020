...
def Student = CustomKeywords.'com.CommonUtilities.ConfirmationPage.CompleteRegistration'([VisitType], findTestObject('Add Attendee/DailyVisitsOptionInAddAttendee'))
