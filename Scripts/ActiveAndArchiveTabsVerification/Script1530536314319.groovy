...
WebUI.waitForElementPresent(findTestObject('VisitTypesPage/ActiveTab'), 0)

WebUI.verifyElementPresent(findTestObject('VisitTypesPage/ActiveTab'), 0)

WebUI.verifyElementPresent(findTestObject('VisitTypesPage/ArchivedTab'), 0)
