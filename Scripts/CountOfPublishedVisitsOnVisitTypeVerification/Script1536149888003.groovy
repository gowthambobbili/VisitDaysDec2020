...
WebUI.sendKeys(findTestObject('VisitTypesPage/SearchVisitTypesTextBox'), VisitTypeName)

WebUI.delay(5)

String TextFromNumberOfVisitsDivision = driver.findElement(By.xpath("//h4[text()='"+VisitTypeName+"']/../..//div[@class='vt-visits flex-center']")).getText()

String NumberOfVisits = TextFromNumberOfVisitsDivision[0]

println NumberOfVisits

WebUI.verifyMatch(NumberOfVisits, '3', false)
