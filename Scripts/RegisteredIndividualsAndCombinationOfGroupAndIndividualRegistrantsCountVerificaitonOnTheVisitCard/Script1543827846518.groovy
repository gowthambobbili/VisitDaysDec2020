...
String ProspectiveStudentsCountOnVisitCard = WebUI.getText(Object)

String ExpectedProspectedStudentCountOnVisitCard = '1'

WebUI.verifyMatch(ProspectiveStudentsCountOnVisitCard, ExpectedProspectedStudentCountOnVisitCard, false)

def Object1 = new TestObject('GuestCountOnVisitCard')

Object1.addProperty('xpath', ConditionType.EQUALS, ('//h4[text()=\'' + DailyVisitVisitType) + '\']/../../../..//p[text()=\'Guests\']/..//h3')

String GuestCountOnVisitCard = WebUI.getText(Object1)

String ExpectedGuestCountOnVisitCard = '0'

WebUI.verifyMatch(GuestCountOnVisitCard, ExpectedGuestCountOnVisitCard, false)

def Object2 = new TestObject('TotalRegistrantsCountOnVisitCard')

Object2.addProperty('xpath', ConditionType.EQUALS, ('//h4[text()=\'' + DailyVisitVisitType) + '\']/../../../..//p[text()=\'Total Registrants\']/..//h3')

//h4[text()='Information Session']/../../../..//p[text()='Prosp. Students']/..//h3
//h4[text()='Information Session']/../../../..//p[text()='Total Registrants']/..//h3
String TotalCountOnVisitCard = WebUI.getText(Object2)

String ExpectedTotalCountOnVisitCard = '1'

WebUI.verifyMatch(TotalCountOnVisitCard, ExpectedTotalCountOnVisitCard, false)
...
//h4[text()='Test Visit Type44249']/../../../..//p[text()='Prosp. Students']/..//h3
Object = new TestObject('PropectiveStudentCountOnVisitCard')

Object.addProperty('xpath', ConditionType.EQUALS, ('//h4[text()=\'' + DailyVisitVisitType) + '\']/../../../..//p[text()=\'Prosp. Students\']/..//h3')

String ProspectiveStudentsCountOnVisitCardForGroupAndIndividualCombination = WebUI.getText(Object)

String ExpectedProspectedStudentCountOnVisitCardForGroupAndIndividualCombination = '4'

WebUI.verifyMatch(ProspectiveStudentsCountOnVisitCardForGroupAndIndividualCombination, ExpectedProspectedStudentCountOnVisitCardForGroupAndIndividualCombination, false)
...
WebUI.verifyMatch(GuestCountOnVisitCardForGroupAndIndividualCombination, ExpectedGuestCountOnVisitCardForGroupAndIndividualCombination, false)
...
String ExpectedTotalCountOnVisitCardForGroupAndIndividualCombination = '7'

WebUI.verifyMatch(TotalCountOnVisitCardForGroupAndIndividualCombination, ExpectedTotalCountOnVisitCardForGroupAndIndividualCombination, false)
