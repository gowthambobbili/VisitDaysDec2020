...
CustomKeywords.'com.CommonUtilities.CreateVisitWithDifferentStatuses.CreateEventWithInPastTimes'(VisitType)
...
if (!(WebUI.verifyElementPresent(status, 10, FailureHandling.OPTIONAL))) {
	KeywordUtil.markFailed('After adding an individual visitor to an Event with past times, the user was not checked in')
