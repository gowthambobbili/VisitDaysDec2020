...
CustomKeywords.'com.CommonUtilities.CreationOperations.CreateDailyVisitWithRequestVisitTypeForFutureDates'(DailyVisitVisitType)
...
driver.findElement(By.xpath("//strong[text()='"+DailyVisitVisitType+"']/../../../..//button/strong")).isDisplayed()
