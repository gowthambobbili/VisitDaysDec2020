...
//    KeywordUtil.markFailed('Cancel Off Campus modal is not shown when user clicks Cancel Daily visit button')
//
//    WebUI.takeScreenshot()
//}
//
...
if (!(WebUI.verifyElementNotPresent(findTestObject('DailyVisitsPage/CancelNowButtonInCancelVisitModal'), 0, FailureHandling.OPTIONAL))) {
	KeywordUtil.markFailed('After selecting the check box and clicking Cancel Now button in Cancel Off Campus modal, the modal is not getting closed')
