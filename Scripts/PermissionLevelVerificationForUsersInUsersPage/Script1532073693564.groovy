...
int NumberOfListElements = driver.findElements(By.xpath('(//span[@class="user-details"]/b)')).size()

for(int i=1;i<=NumberOfListElements;i++)
{
	WebUI.verifyElementPresent(findTestObject('Object Repository/TeamManagement/Users/PermissionLabelForUser'), 0)
}
