...
WebUI.dragAndDropToObject(findTestObject('Object Repository/MobiPage/Questions/DragableButtonOfChoice(index)', ["index":"3"]), findTestObject('Object Repository/MobiPage/Questions/QuestionTypeDropdown'))
...
CustomKeywords.'com.CommonUtilities.Verifications.VerifyElementPresentAndStopExecutionIfFailed'(findTestObject('Object Repository/Add Attendee/IndividualListOption(index)', ["index":"1"]), "When change the order of the newly created List type question options are not shown in incorrect in the Mobi")
def firstoptionInMobi = WebUI.getText(findTestObject('Object Repository/Add Attendee/IndividualListOption(index)', ["index":"1"]))
CustomKeywords.'com.CommonUtilities.Verifications.VerifyTextMatch'(firstoptionInMobi, "Third", "The newly created List type question first option is shown incorrect in the Mobi")
...
CustomKeywords.'com.CommonUtilities.Verifications.VerifyTextMatch'(secondoptionInMobi, "First", "When change the order of the newly created List type question options are not shown in incorrect in the Mobi")
def thirdoptionInMobi = WebUI.getText(findTestObject('Object Repository/Add Attendee/IndividualListOption(index)', ["index":"3"]))
CustomKeywords.'com.CommonUtilities.Verifications.VerifyTextMatch'(thirdoptionInMobi, "Second", "When change the order of the newly created List type question options are not shown in incorrect in the Mobi")
