...
if(!(WebUI.getText(findTestObject('Object Repository/CreateSession/SessionDetailsVisitType'))==VisitType))
	{
		KeywordUtil.markFailed('in details tab the visittype is showing incorrect or wrong session details')
	}
