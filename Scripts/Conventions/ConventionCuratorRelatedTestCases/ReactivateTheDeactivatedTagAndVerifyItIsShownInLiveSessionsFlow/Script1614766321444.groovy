...
WebUI.click(findTestObject('Object Repository/ConventionCurators/Tags/ReactivateButton',['tagName':tagName]))
...
{
	KeywordUtil.markFailed("The reactivated tag is not shown in the created convention flow")
}