...
WebUI.waitForElementPresent(findTestObject('Object Repository/ConventionsPageAdmin/ThreeDotButtonInVideosPage'), 0)
...
{
	KeywordUtil.markFailed("the video is not deleted and present in the videos tab of exhibitors page")
}
