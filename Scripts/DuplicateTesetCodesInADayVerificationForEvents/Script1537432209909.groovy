...
String EventVisitTypeWithKeywordCheckin = CustomKeywords.'com.CommonUtilities.RequestMethods.CreateInstantEventVisitTypeWithKeywordCheckin'()

CustomKeywords.'com.CommonUtilities.CreationOperations.CreateEventWithInstantVisitType'(EventVisitTypeWithKeywordCheckin)
...
driver.findElement(By.xpath(('//li[text()=\'' + EventVisitTypeWithKeywordCheckin) + '\']')).click()
...
String EventVisiytVisitType = CustomKeywords.'com.CommonUtilities.RequestMethods.CreateInstantEventVisitTypeWithManualCheckin'()

CustomKeywords.'com.CommonUtilities.CreationOperations.CreateEventWithInstantVisitType'(EventVisiytVisitType)
...
driver.findElement(By.xpath(('//h4[text()=\'' + EventVisiytVisitType) + '\']')).click()
...
driver.findElement(By.xpath(('//li[text()=\'' + EventVisiytVisitType) + '\']')).click()
