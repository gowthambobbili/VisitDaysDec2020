...
def IndividualStudent = CustomKeywords.'com.CommonUtilities.ConfirmationPage.CompleteRegistration'(Visits, findTestObject('Object Repository/Add Attendee/EventsOptionInAddAttendee'))
