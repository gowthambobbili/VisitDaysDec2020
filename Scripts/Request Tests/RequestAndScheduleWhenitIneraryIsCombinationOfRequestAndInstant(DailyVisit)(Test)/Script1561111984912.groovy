...
List Visits = [RequestVisitType, InstantVisitType]

WebUI.navigateToUrl(GlobalVariable.EvrUrl)

def IndividualStudent = CustomKeywords.'com.CommonUtilities.ConfirmationPage.CompleteRegistration'(Visits, findTestObject('Object Repository/Add Attendee/OffCampusOptionInAddAttendee'))
