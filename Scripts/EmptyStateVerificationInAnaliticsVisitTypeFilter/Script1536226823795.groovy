...
if(!(WebUI.verifyElementPresent(findTestObject('AnalyticsPage/EmptyStateMessageAndEmojiInAnalytics'), 0)))
{
	WebUI.takeScreenshot()
	KeywordUtil.markFailedAndStop("After selecting a visit type in Visit Type filter the empty state message and emoji are not shown")
}
