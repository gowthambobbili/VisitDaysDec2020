...
WebUI.verifyElementPresent(findTestObject('DailyVisitsPage/Visitor Insights/ExpectedEntryYear'), 1)

CustomKeywords.'com.CommonUtilities.VerifyNumberOfOptionsPresentInVisitorInsights.VerificationOfNumberOfOptionsInVisitorInsights'(
		'Expected Entry Year')

WebUI.verifyElementPresent(findTestObject('DailyVisitsPage/Visitor Insights/ApplicationStatus'), 1)

CustomKeywords.'com.CommonUtilities.VerifyNumberOfOptionsPresentInVisitorInsights.VerificationOfNumberOfOptionsInVisitorInsights'(
		'Application Status')

WebUI.verifyElementPresent(findTestObject('DailyVisitsPage/Visitor Insights/CurrentSchool'), 1)

CustomKeywords.'com.CommonUtilities.VerifyNumberOfOptionsPresentInVisitorInsights.VerificationOfNumberOfOptionsInVisitorInsights'(
		'Current School')

WebUI.verifyElementPresent(findTestObject('DailyVisitsPage/Visitor Insights/AcademicInterest'), 1)

CustomKeywords.'com.CommonUtilities.VerifyNumberOfOptionsPresentInVisitorInsights.VerificationOfNumberOfOptionsInVisitorInsights'(
		'Academic Interest')

WebUI.verifyElementPresent(findTestObject('DailyVisitsPage/Visitor Insights/Location'), 1)
...
WebUI.verifyElementPresent(findTestObject('DailyVisitsPage/Visitor Insights/DietaryNeeds'), 0)
...
//WebUI.verifyElementPresent(findTestObject('DailyVisitsPage/Visitor Insights/GuestAccessibilityNeeded'), 1)
//
//CustomKeywords.'com.CommonUtilities.VerifyNumberOfOptionsPresentInVisitorInsights.VerificationOfNumberOfOptionsInVisitorInsights'(
...
if (!(WebUI.verifyElementPresent(findTestObject('DailyVisitsPage/Visitor Insights/EntryTypeHeader'), 0))) {
...
if (!(WebUI.verifyElementPresent(findTestObject('DailyVisitsPage/Visitor Insights/ExpectedEntryYearHeader'), 0))) {
