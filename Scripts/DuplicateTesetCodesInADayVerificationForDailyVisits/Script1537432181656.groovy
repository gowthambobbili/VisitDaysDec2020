...
String DailyVisitWithKeywordCheckin = CustomKeywords.'com.CommonUtilities.RequestMethods.CreateInstantVisitTypeWithKeywordCheckin'()

CustomKeywords.'com.CommonUtilities.CreationOperations.CreateDailyVisitWithInstantVisitType'(DailyVisitWithKeywordCheckin)
...
driver.findElement(By.xpath(('//li[text()=\'' + DailyVisitWithKeywordCheckin) + '\']')).click()
...
String DailyVisiytVisitType = CustomKeywords.'com.CommonUtilities.RequestMethods.CreateInstantVisitTypeWithMenualCheckin'()

CustomKeywords.'com.CommonUtilities.CreationOperations.CreateDailyVisitWithInstantVisitType'(DailyVisiytVisitType)
...
driver.findElement(By.xpath(('//h4[text()=\'' + DailyVisiytVisitType) + '\']')).click()
...
driver.findElement(By.xpath(('//li[text()=\'' + DailyVisiytVisitType) + '\']')).click()
