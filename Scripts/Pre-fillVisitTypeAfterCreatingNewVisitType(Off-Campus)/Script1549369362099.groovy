...
def PrefilledDataVerification(String VisitType, String RegistrationMethodOfVisitType) {
	CustomKeywords.'com.CommonUtilities.Verifications.VerifyElementPresentAndStopExecutionIfFailed'(findTestObject('OffCampusPage/CreateOffCampusHeader'),
			'While creating Off-Campus visit type if user clicks \'Create Off-Campus\' button then Create Off-Campus page is not opened ')
	...
	CustomKeywords.'com.CommonUtilities.Verifications.VerifyElementPresentAndStopExecutionIfFailed'(findTestObject('DailyVisitsPage/VisitTypeFieldInDailyVisit'),
			'While creating Off-Campus visit type if user clicks \'Create Off-Campus\' button then Visit type drop down is not shown in Create Off-Campus page')
	...
	CustomKeywords.'com.CommonUtilities.Verifications.VerifyElementPresentAndStopExecutionIfFailed'(findTestObject('DailyVisitsPage/SelectedVisitTypeInVisitTypeDropdown'),
			'While creating Off-Campus visit type if user clicks \'Create Off-Campus\' button then Visit type is not pre-filled and it shows empty')

	String PreFillerVisitType = WebUI.getText(findTestObject('DailyVisitsPage/SelectedVisitTypeInVisitTypeDropdown'))

	WebUI.verifyMatch(PreFillerVisitType, VisitType, false)
