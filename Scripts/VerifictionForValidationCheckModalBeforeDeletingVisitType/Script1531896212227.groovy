...
WebUI.verifyElementPresent(findTestObject('VisitTypesPage/FirstCheckboxInDeleteVisitTypeModal'), 0)

WebUI.verifyElementPresent(findTestObject('VisitTypesPage/SecondCheckBoxInDeleteVisitTypeModal'), 0)

WebUI.verifyElementPresent(findTestObject('VisitTypesPage/ThierdCheckBoxInDeleteVisitTypeModal'), 0)

WebUI.verifyElementPresent(findTestObject('VisitTypesPage/VisitTypeNameTextBoxInDeleteVisitTypeModal'), 0)

WebUI.verifyElementPresent(findTestObject('VisitTypesPage/DeleteVisitTypeInDeleteVisitTypeModal'), 0)

WebUI.verifyElementPresent(findTestObject('VisitTypesPage/DontDeleteButtonInDeleteVisitTypeModal'), 0)
